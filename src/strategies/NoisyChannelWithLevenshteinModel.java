...
public class NoisyChannelWithLevenshteinModel implements CorrectionStrategy {
	...
	public NoisyChannelWithLevenshteinModel()
	{
	...
	public String findCorrection(String inputWord,
		...
		for (String candidate : candidates.keySet())
		{
			...
			case DELETE:
				...
				insertionValue = this.deletionMatrix[insertTypo][insertCorrection];
				count = this.multipleCharMatrix[insertTypo][insertCorrection] * 2000;
			...
			case SUBSTITUTION:
				...
				insertionValue = this.substitutionMatrix[insertTypo][insertCorrection];;
				count = this.singleCharMatrix[insertCorrection] * 2000;
			...
			case REVERSAL:
				...
				insertionValue = this.reversalMatrix[insertTypo][insertCorrection];;
				count = this.multipleCharMatrix[insertTypo][insertCorrection] * 2000;
	...
	{
		HashMap<EDIT, Integer> editLocation = new HashMap<NoisyChannelWithLevenshteinModel.EDIT, Integer>();
